#
# Table structure for table 'tx_pxasocialfeed_domain_model_feeds'
#
CREATE TABLE tx_pxasocialfeed_domain_model_feeds (
  ...
  post_date int(11) DEFAULT '0' NOT NULL,
	...
	external_url varchar(510) DEFAULT '' NOT NULL,
...
#
# Table structure for table 'tx_pxasocialfeed_domain_model_tokens'
#
CREATE TABLE tx_pxasocialfeed_domain_model_tokens (
...
#
CREATE TABLE tx_pxasocialfeed_domain_model_config (
